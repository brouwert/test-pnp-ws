...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      {
        "name": "acme-app",
        "reference": "workspace:apps/acme-app"
      },
      {
        "name": "lib-ui",
        "reference": "workspace:libs/lib-ui"
      }
    ],
    "enableTopLevelFallback": true,
    "ignorePatternData": "(^(?:\\.yarn\\/sdks(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)|$))$)",
    "fallbackExclusionList": [
      ["acme-app", ["workspace:apps/acme-app"]],
      ["lib-ui", ["workspace:libs/lib-ui"]],
    ...
    "packageRegistryData": [
      ...
      ["acme-app", [
        ["workspace:apps/acme-app", {
          "packageLocation": "./apps/acme-app/",
          "packageDependencies": [
            ["acme-app", "workspace:apps/acme-app"],
            ["lib-ui", "workspace:libs/lib-ui"]
          ],
